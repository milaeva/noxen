  ...
  k.prototype = {
    ...
    update: function () {
      ...
      return (
        ...
        d
          ? this.setValue()
          : c.length && String(b) !== String(this.dates) && this._trigger("changeDate"),
    ...
    getClassNames: function (b) {
      var c = [],
        ...
        f = new Date()
      return (
        b.getUTCFullYear() < d || (b.getUTCFullYear() === d && b.getUTCMonth() < e)
          ? c.push("old")
          : (b.getUTCFullYear() > d || (b.getUTCFullYear() === d && b.getUTCMonth() > e)) &&
            c.push("new"),
        ...
        for (var u, v = []; p.valueOf() < t; ) {
          if (p.getUTCDay() === this.o.weekStart && (v.push("<tr>"), this.o.calendarWeeks)) {
            var w = new Date(+p + ((this.o.weekStart - p.getUTCDay() - 7) % 7) * 864e5),
              ...
              y = new Date(
                Number((y = c(x.getUTCFullYear(), 0, 1))) + ((11 - y.getUTCDay()) % 7) * 864e5
              ),
              z = (x - y) / 864e5 / 7 + 1
    ...
    updateNavArrows: function () {
      if (this._allow_update) {
        ...
        switch (this.viewMode) {
          ...
          case 3:
          case 4:
            ;(this.o.startDate !== -(1 / 0) && b <= this.o.startDate.getUTCFullYear()) ||
            this.o.maxViewMode < 2
              ? this.picker.find(".prev").css({ visibility: "hidden" })
              : this.picker.find(".prev").css({ visibility: "visible" }),
              (this.o.endDate !== 1 / 0 && b >= this.o.endDate.getUTCFullYear()) ||
              this.o.maxViewMode < 2
                ? this.picker.find(".next").css({ visibility: "hidden" })
                : this.picker.find(".next").css({ visibility: "visible" })
        }
    ...
    click: function (b) {
      ...
      l.length > 0 &&
        ...
        e.hasClass("today") &&
          !e.hasClass("day") &&
          (this.showMode(-2), this._setDate(d(), "linked" === this.o.todayBtn ? null : "view")),
        ...
        e.hasClass("disabled") ||
          (e.hasClass("day") &&
            ...
            e.hasClass("old") &&
              (0 === i ? ((i = 11), (h -= 1), (j = !0), (k = !0)) : ((i -= 1), (j = !0))),
            e.hasClass("new") &&
              (11 === i ? ((i = 0), (h += 1), (j = !0), (k = !0)) : ((i += 1), (j = !0))),
    ...
    _toggle_multidate: function (a) {
      ...
      if (
        (a || this.dates.clear(),
        -1 !== b
          ? (this.o.multidate === !0 || this.o.multidate > 1 || this.o.toggleActive) &&
            this.dates.remove(b)
          : this.o.multidate === !1
