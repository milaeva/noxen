            ...
            enterFullScreen: function () {
              ...
              if (
                ...
                if (
                  ...
                  for (
                    var o = e.container.querySelectorAll("embed, object, video"),
                      a = o.length,
                      s = 0;
                    s < a;
                    s++
            ...
            exitFullScreen: function () {
              ...
              if (
                ...
                if (
                  ...
                  for (
                    var n = e.container.querySelectorAll("embed, object, video"),
                      o = n.length,
                      i = 0;
                    i < o;
                    i++
              ...
              var y = function (t) {
                      ...
                      if (p.timefloat) {
                        ...
                        ;(f =
                          h - b.left < p.timefloat.offsetWidth
                            ...
                            : m),
                          (0, u.hasClass)(p.container, p.options.classPrefix + "long-video") &&
                            (f += parseFloat(E.marginLeft) / 2 + p.timefloat.offsetWidth / 2),
                ...
                E = function () {
                  c &&
                    null !== p.getCurrentTime() &&
                    p.newTime.toFixed(4) !== p.getCurrentTime().toFixed(4) &&
                    (p.setCurrentTime(p.newTime), p.setCurrentRail(), p.updateCurrent(p.newTime)),
              ...
              p.slider.addEventListener("mouseenter", function (e) {
                e.target === p.slider &&
                  ...
                  (p.container.addEventListener("mousemove", function (e) {
                    var t = e.target
                    ;(t === p.slider || t.closest("." + p.options.classPrefix + "time-slider")) &&
                      y(e)
                  }),
                ...
                p.container.addEventListener("controlsresize", function (t) {
                  p.getDuration() !== 1 / 0 &&
                    (e.setProgressRail(t), p.forcedHandlePause || e.setCurrentRail(t))
                })
            },
          ...
          Object.assign(a.default.prototype, {
            ...
            buildduration: function (e, t, n, o) {
              ...
              if (t.lastChild.querySelector("." + r.options.classPrefix + "currenttime"))
                ...
                ;(a.className =
                  r.options.classPrefix + "time " + r.options.classPrefix + "duration-container"),
                  (a.innerHTML =
                    '<span class="' +
                    r.options.classPrefix +
                    'duration">' +
            ...
            updateCurrent: function () {
              ...
              n.length > 5
                ? (0, l.addClass)(e.container, e.options.classPrefix + "long-video")
                : (0, l.removeClass)(e.container, e.options.classPrefix + "long-video"),
                e.controls.querySelector("." + e.options.classPrefix + "currenttime") &&
                  (e.controls.querySelector("." + e.options.classPrefix + "currenttime").innerText =
                    n)
            },
            updateDuration: function () {
              ...
              n.length > 5
                ? (0, l.addClass)(e.container, e.options.classPrefix + "long-video")
                : (0, l.removeClass)(e.container, e.options.classPrefix + "long-video"),
                e.controls.querySelector("." + e.options.classPrefix + "duration") &&
                  t > 0 &&
                  (e.controls.querySelector("." + e.options.classPrefix + "duration").innerHTML = n)
            },
          })
      },
        ...
        Object.assign(s.config, {
          ...
          Object.assign(l.default.prototype, {
            ...
            buildtracks: function (e, t, n, o) {
              if (
                (this.findTracks(), e.tracks.length || (e.trackFiles && 0 !== !e.trackFiles.length))
              ) {
                var r = this,
                ...
                r.cleartracks(e),
                  ...
                  (e.captions.className =
                    r.options.classPrefix + "captions-layer " + r.options.classPrefix + "layer"),
                ...
                for (var y = 0; y < f; y++) {
                  ...
                  !e.tracks[y].src.trim() ||
                    ...
                    e.addTrackButton(e.tracks[y].trackId, e.tracks[y].srclang, e.tracks[y].label)
                }
                e.loadNextTrack()
                ...
                for (var L = 0, F = b.length; L < F; L++)
                  e.chaptersButton.addEventListener(b[L], function () {
                    this.querySelector("." + r.options.classPrefix + "chapters-selector-list")
                      .children.length &&
                      (0, c.removeClass)(
                ...
                e.chaptersButton.addEventListener("keydown", function (e) {
                  ...
                  e.options.alwaysShowControls
                    ...
                    : (e.container.addEventListener("controlsshown", function () {
                        ;(0,
                        c.addClass)(e.container.querySelector("." + r.options.classPrefix + "captions-position"), r.options.classPrefix + "captions-position-hover")
                      }),
            ...
            searchTrackPosition: function (e, t) {
              for (var n = 0, o = e.length - 1, i = void 0, r = void 0, a = void 0; n <= o; ) {
                if (((i = (n + o) >> 1), (r = e[i].start), (a = e[i].stop), t >= r && t < a))
                  return i
                r < t ? (n = i + 1) : r > t && (o = i - 1)
              }
              return -1
            ...
            dfxp: {
              parse: function (e) {
                ...
                for (var u = 0, c = n.length; u < c; u++) {
                  ...
                  if (
                    (n.eq(u).attr("begin") &&
                      (p.start = (0, d.convertSMPTEtoSeconds)(n.eq(u).attr("begin"))),
                    !p.start &&
                      n.eq(u - 1).attr("end") &&
                      (p.start = (0, d.convertSMPTEtoSeconds)(n.eq(u - 1).attr("end"))),
                    n.eq(u).attr("end") &&
                      (p.stop = (0, d.convertSMPTEtoSeconds)(n.eq(u).attr("end"))),
                    !p.stop &&
                      n.eq(u + 1).attr("begin") &&
            ...
            buildvolume: function (e, t, n, o) {
              if ((!l.IS_ANDROID && !l.IS_IOS) || !this.options.hideVolumeOnTouchDevices) {
                ...
                var y = !1,
                  ...
                  S =
                    "vertical" === c
                      ? a.container.querySelector("." + a.options.classPrefix + "volume-slider")
                      : a.container.querySelector(
                          "." + a.options.classPrefix + "horizontal-volume-slider"
                        ),
                  x =
                    "vertical" === c
                      ? a.container.querySelector("." + a.options.classPrefix + "volume-total")
                      : a.container.querySelector(
                          "." + a.options.classPrefix + "horizontal-volume-total"
                        ),
                  w =
                    "vertical" === c
                      ? a.container.querySelector("." + a.options.classPrefix + "volume-current")
                      : a.container.querySelector(
                          "." + a.options.classPrefix + "horizontal-volume-current"
                        ),
                  P =
                    "vertical" === c
                      ? a.container.querySelector("." + a.options.classPrefix + "volume-handle")
                      : a.container.querySelector(
                          "." + a.options.classPrefix + "horizontal-volume-handle"
                        ),
                  T = function (e) {
        ...
        var b = (function () {
          function e(t, n) {
            ...
            if (((o.node = o.media = r), o.node)) {
              ...
              if (
                ((o.isDynamic = "audio" !== c && "video" !== c && "iframe" !== c),
                (o.isVideo = o.isDynamic ? o.options.isVideo : "audio" !== c && o.options.isVideo),
                (o.mediaFiles = null),
                (o.trackFiles = null),
                ...
                (!o.isVideo &&
                  (o.isVideo || (!o.options.features.length && !o.options.useDefaultControls))) ||
                ...
                if (
                  ...
                  o.container.addEventListener("focus", function (e) {
                    if (!o.controlsAreVisible && !o.hasFocus && o.controlsEnabled) {
                      ...
                      var t = (0, m.isNodeAfter)(e.relatedTarget, o.container)
                        ...
                        : "." + o.options.classPrefix + "playpause-button > button"
                  ...
                  o.isVideo &&
                    ...
                    !y.hasClass(o.container.parentNode, o.options.classPrefix + "fill-container"))
                ) {
                ...
                if (
                  (p.IS_ANDROID && y.addClass(o.container, o.options.classPrefix + "android"),
                  p.IS_IOS && y.addClass(o.container, o.options.classPrefix + "ios"),
                  p.IS_IPAD && y.addClass(o.container, o.options.classPrefix + "ipad"),
                  p.IS_IPHONE && y.addClass(o.container, o.options.classPrefix + "iphone"),
                  y.addClass(
                    o.container,
                    o.isVideo ? o.options.classPrefix + "video" : o.options.classPrefix + "audio"
                  ),
                ...
                o.options[N + "Width"] > 0 || o.options[N + "Width"].toString().indexOf("%") > -1
                  ...
                  (o.initialAspectRatio =
                    o.height >= o.width ? o.width / o.height : o.height / o.width),
            ...
            a(e, [
                  ...
                  if (((e = void 0 === e || e), !t.controlsAreVisible && t.isVideo)) {
                    if (e)
                      ...
                      for (
                        ...
                        y.removeClass(n[o], t.options.classPrefix + "offscreen"),
                          (n[o].style.display = "")
                    ...
                    if (e)
                      !(function () {
                        y.fadeOut(n.controls, 200, function () {
                          y.addClass(n.controls, n.options.classPrefix + "offscreen"),
                        ...
                        for (
                          ...
                          !(function (t, o) {
                            y.fadeOut(e[t], 200, function () {
                              y.addClass(e[t], n.options.classPrefix + "offscreen"),
                                (e[t].style.display = "")
                            })
                          })(t)
                      })()
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  if (
                    ...
                    n.container &&
                      n.container.querySelector("." + n.options.classPrefix + "overlay-play") &&
                    ...
                    if (
                          ...
                          if (n.options.autoRewind)
                            try {
                              n.setCurrentTime(0),
                                setTimeout(function () {
                                  var e = n.container.querySelector(
                                    "." + n.options.classPrefix + "overlay-loading"
                                  )
                      ...
                      n.media.addEventListener("timeupdate", function () {
                        isNaN(n.getDuration()) ||
                          g === n.getDuration() ||
                          ((g = n.getDuration()),
                          (0, h.calculateTimeFormat)(g, n.options, n.options.framesPerSecond || 25),
                          n.updateDuration && n.updateDuration(),
                          n.updateCurrent && n.updateCurrent(),
                          n.setControlsSize())
                      }),
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  i && (i.style.display = "none"),
                    ...
                    o.container.querySelector("." + o.options.classPrefix + "cannotplay") &&
                      o.container.querySelector("." + o.options.classPrefix + "cannotplay").remove()
                  ...
                  a &&
                    o.layers.querySelector("." + o.options.classPrefix + "overlay-error") &&
                    ((r.innerHTML = a),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    for (var c = e.layers.children, f = 0, m = c.length; f < m; f++)
              ...
              },
              {
                ...
                value: function () {
                  ...
                  "none" !== e.node.style.height &&
                    ...
                    n || parseFloat(o.width) || (t.style.width = e.media.offsetWidth + "px"),
                    n || parseFloat(o.height) || (t.style.height = e.media.offsetHeight + "px"),
                  ...
                  a && (a.style.display = "")
                  for (
                    var l = e.container.querySelectorAll("object, embed, iframe, video"),
                      d = e.height,
                      u = e.width,
                      c = i,
                      f = (d * i) / u,
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  for (var o = n.layers.children, i = 0, r = o.length; i < r; i++)
                ...
                value: function () {
                  ...
                  if (y.visible(e.container))
                    if (e.rail && y.visible(e.rail)) {
                      ...
                      for (var u = e.controls.children, c = 0, f = 0, p = u.length; f < p; f++)
                        c += u[f].offsetWidth
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this
                  ;(t.container.className = t.options.classPrefix + "container " + e),
                  ...
                  a ? -1 === a.indexOf("%") && (a += "px") : (a = "auto"),
                    ...
                    "object" === r(e.container) &&
                      (e.container.parentNode
                        .querySelector("." + e.options.classPrefix + "offscreen")
                        .remove(),
                      e.container.remove()),
                  ...
                  ;(p["get" + n] = function () {
                    ...
                    (p["set" + n] = function (n) {
                      if (-1 === a.default.html5media.readOnlyProperties.indexOf(e))
                        if ("src" === e) {
                          var o =
                            "object" === (void 0 === n ? "undefined" : i(n)) && n.src ? n.src : n
                          if (((p[e] = o), null !== m)) {
                            m.reset()
        ...
        var i =
          ...
          p = {
            ...
            create: function (e, t, n) {
                    ...
                    (u["set" + n] = function (n) {
                      if (-1 === a.default.html5media.readOnlyProperties.indexOf(e))
                        if ("src" === e) {
                          if (
                            ((u[e] =
                              "object" === (void 0 === n ? "undefined" : i(n)) && n.src
                                ? n.src
                                : n),
                            null !== c)
                          ) {
              ...
              if (
                ((r.default["__ready__" + d] = function (t) {
                  ...
                  for (var n = flvjs.Events, o = 0, i = m.length; o < i; o++)
                    !(function (e) {
                      "loadedmetadata" === e &&
                        (c.unload(), c.detachMediaElement(), c.attachMediaElement(u), c.load()),
              ...
              return (
                e.dispatchEvent(x), e.promises.push(f.load({ options: E, configs: S, id: d })), u
              )
            },
          }
                      ...
                      if (-1 === a.default.html5media.readOnlyProperties.indexOf(e))
                        if ("src" === e) {
                          if (
                            ...
                            ;(p = f._createPlayer({ options: t.hls, id: d })).loadSource(n),
                              p.attachMedia(m)
                          }
                        } else m[e] = n
                    })
                        ...
                        if ((console.warn(o), (o = o[1]).fatal))
                          switch (o.type) {
                            case "mediaError":
                              ...
                              if (!a || i - a > 3e3)
                                (a = new Date().getTime()), p.recoverMediaError()
                              else if (!s || i - s > 3e3)
                                (s = new Date().getTime()),
                                  console.warn(
                            ...
                            case "networkError":
                              if ("manifestLoadError" === o.details)
                                h < v && (m.setSrc(n[h++].src), m.load(), m.play())
                              else {
        ...
        var i = o(e(3)),
          ...
          u = {
            ...
            create: function (e, t, n) {
              ...
              for (
                var p = a.default.html5media.events.concat(["click", "mouseover", "mouseout"]),
                  m = 0,
                  h = p.length;
                m < h;
                m++
        ...
        var i = o(e(3)),
          ...
          c = {
            ...
            loadIframeApi: function () {
              c.isIframeStarted ||
                ((0, u.loadScript)("https://www.youtube.com/player_api"), (c.isIframeStarted = !0))
            },
                ...
                C = {
                  ...
                  events: {
                    onReady: function (t) {
                      ...
                      for (
                        var h = ["rendererready", "loadedmetadata", "loadeddata", "canplay"],
                          v = 0,
                          y = h.length;
                        v < y;
                        v++
      ...
      function (e, t, n) {
        ...
        function i(e) {
          ...
          return (
            (g += (f < 10 ? "0" + f : f) + ":"),
            (g += "" + (p < 10 ? "0" + p : p)),
            n && (g += (m = (m = (h % s).toFixed(0)) <= 0 ? 0 : m) < 10 ? u + "0" + m : "" + u + m),
            g
          )
        }
        function r(e) {
